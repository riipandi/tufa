...
public abstract class TufaActivity extends AppCompatActivity implements TufaApplication.LockListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // set FLAG_SECURE on the window of every TufaActivity
    ...
    protected TufaApplication getApp() {
        return _app;
    }
