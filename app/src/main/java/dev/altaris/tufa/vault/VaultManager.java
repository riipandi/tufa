...
public class VaultManager {
    public static final String FILENAME = "tufa.json";
    public static final String FILENAME_EXPORT = "tufa-export.json";
    public static final String FILENAME_EXPORT_PLAIN = "tufa-export-plain.json";
