...
import dev.altaris.tufa.ui.MainActivity;
...
public class TufaApplication extends Application {
    ...
    public void lock() {
        ...
        stopService(new Intent(TufaApplication.this, NotificationService.class));
    }
