...
# example usage: ./scripts/decrypt.py --input ./testdata/tufa_export.json
# password: test
...
def main():
    parser = argparse.ArgumentParser(description="Decrypt an Tufa vault")
    parser.add_argument("--input", dest="input", required=True, help="encrypted Tufa vault file")
    parser.add_argument("--output", dest="output", default="-", help="output file ('-' for stdout)")
    args = parser.parse_args()

    # parse the Tufa vault file
